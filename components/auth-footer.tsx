...
export default function AuthFooter({
  ...
  return (
    <div className="mt-6 text-center text-[11px] leading-relaxed text-gray-500">
      <p className="mx-auto max-w-full px-2">
        Ao clicar em {actionText} acima, você reconhece que leu e entendeu, e
        concorda com os nossos{" "}
        <Link href="/termos" className="text-gray-400 underline hover:text-gray-300">
          Termos e Condições
        </Link>{" "}
        e a{" "}
        <Link href="/privacidade" className="text-gray-400 underline hover:text-gray-300">
