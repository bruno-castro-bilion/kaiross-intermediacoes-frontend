...
export function RevenueIndicator({ value = 6254.54, showBalance = true }: RevenueIndicatorProps) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-amber-200/40 bg-amber-50/60 px-4 py-2 shadow-sm dark:border-amber-500/20 dark:bg-amber-500/10">
      {/* Labels + valor */}
      <div className="flex flex-col gap-0.5 min-w-0">
        <span className="text-[10px] font-medium text-amber-600/70 dark:text-amber-400/70 uppercase tracking-wider leading-none">
          Faturamento
        </span>
        <span
      ...
      {/* Barra de progresso */}
      <div className="flex flex-col gap-1 w-36 lg:w-48">
        <div className="relative h-2 w-full rounded-full bg-amber-200/50 dark:bg-amber-500/20 overflow-hidden">
          <motion.div
        ...
        <div className="flex justify-between">
          <span className="text-[9px] text-amber-600/50 dark:text-amber-400/50">0</span>
          <span className="text-[9px] font-semibold text-amber-600/70 dark:text-amber-400/70">
