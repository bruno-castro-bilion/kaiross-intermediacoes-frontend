  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-1.5">
        ...
        {emailNotFound && (
          <div className="animate-in fade-in slide-in-from-top-1 flex items-center gap-1 text-red-500">
            <AlertCircle size={16} fill="currentColor" className="stroke-black" strokeWidth={3} />
            <p className="text-xs">
              Desculpe, nenhuma conta foi encontrada com este e-mail.
            </p>
          </div>
        )}
      </div>
